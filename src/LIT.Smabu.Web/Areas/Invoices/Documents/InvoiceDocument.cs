    ...
    public class InvoiceDocument(InvoiceWithItemsDTO invoice) : IDocument
    {
        ...
        public void Compose(IDocumentContainer container)
        {
            container
               .Page(page =>
               {
                   ...
                   page.Header().Component(new HeaderComponent("Rechung"));
        ...
        void ComposeContent(IContainer container)
        {
            container.PaddingTop(80).PaddingBottom(40).PaddingLeft(Constants.PaddingMedium).Column(column =>
            {
                ...
                {
                    row.RelativeItem().Component(new AddressComponent(senderAddress, invoice.Customer.MainAddress));
                    row.ConstantItem(20);
                    row.RelativeItem().Component(new InfoBlockComponent(invoice.Number.Long, invoice.ReleasedOn, invoice.Customer.Number.Long, invoice.PerformancePeriod));
                });
